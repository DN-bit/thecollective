...
CRITICAL RULES:
- ALWAYS lead with live price data if provided
- Corpus entries marked as "older" are background context only — NEVER present them as current drivers
- If an entry is from weeks ago, say so explicitly
- Prioritize: Live Grok > Live News > Recent Corpus (14d) > Older Corpus
...
{live_price if live_price else ""}
{fear_greed if fear_greed else ""}
{live_driver if live_driver else ""}
...
Answer directly. Be honest about data recency. Use live data to anchor the answer."""
